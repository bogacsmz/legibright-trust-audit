...
banner "BEAT 1 · a backtest that looks GREAT → Legibright says NO"
...
echo "   3-round adversarial self-audit + demo prep → 13 real flaws fixed, 6 honest limits documented."
...
echo "   main.matches → Quality (3 assertions FAIL) · Incidents (ACTIVE) · Tags · Trust Score 28/100 · deprecation proposal"
